  ...
  <main id="main" class="site-main" role="main" ng-init="propertyId=<?php echo $property['id']; ?>;initializeData();">
    <div class="row layout-1">
      ...
      <div class="col-lg-8" style="margin-bottom:24px">
              ...
              <div id="property-amenities">
                <div class="row">
                  ...
                  if($property['unit_amenities']['amenity']['amenity_name']){
                    ?>
                    <div class="col-md-12">
                      <i class="fa fa-check"></i> <?php echo $property['unit_amenities']['amenity']['amenity_name']; ?>
                    </div>
                    <?php
                  }else{
                    foreach ($property['unit_amenities']['amenity'] as $amenity) {
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                        <i class="fa fa-check"></i> <?php echo $amenity['amenity_name']; ?>
                      </div>
                    <?php }
                  }
                  ?>
        ...
        <?php endif; ?>
        <?php if(isset($options['unit_tab_reviews']) && $options['unit_tab_reviews'] == 1): ?>
          <div class="reviews-content" ng-init="getPropertyReviews(<?php echo $property['id']; ?>)">
            <a name="reviews-title" class="anchor"><?php _e( 'Reviews', 'streamline-core' ) ?></a>
            <div class="row" style="margin-top:24px;" ng-if="reviews.length > 0">
              <div class="col-md-12">
        ...
        <?php if(isset($options['unit_tab_room_details']) && $options['unit_tab_room_details'] == 1): ?>
          <div class="rooms-content" ng-init="getRoomDetails(<?php echo $property['id']; ?>)">
            ...
            <div class="row" ng-if="room_details.length > 0">
              <div class="col-md-12">
          ...
          <form action="<?php echo $checkout_url ?>" method="post" name="resortpro_form_checkout">
            ...
            <div>
              ...
              <h3 class="price" ng-if="res == 1 && total_reservation > 0" ng-cloak>
                ...
                <span class="concluding_text"><?php _e( 'including taxes and fees', 'streamline-core' ) ?></span>
              </h3>
                ...
                <div class="row" style="margin-bottom: 16px">
                  <div class="col-md-12">
                    ...
                    <div class="pbg_info"
                      ...
                      <button type="button" ng-disabled="isDisabled" class="btn btn-block btn-lg btn-success">Split the cost  <span style="font-size:0.8em" ng-if="total_reservation > 0" ng-bind="' - ' + ((total_reservation / book.occupants) | currency:undefined:0) + ' per guest'"></span> </button>
                    </div>
                  </div>
                </div>
              <?php endif; ?>
