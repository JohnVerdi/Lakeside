                ...
                <div class="row">
                    ...
                    <div class='col-md-6'>
                        <div class="form-group">
                            ...
                            <input id="min_people" name="min_people" type="text" min="1" placeholder="<?php _e("Min No. People",ST_TEXTDOMAIN) ?>" class="form-control number" value="<?php echo STInput::request('min_people',get_post_meta($post_id ,'min_people', true)) ?>">
                    ...
                    <div class='col-md-6'>
                        <div class="form-group">
                            ...
                            <input id="max_people" name="max_people" type="text" min="0" placeholder="<?php _e("Max No. People",ST_TEXTDOMAIN) ?>" class="form-control number" value="<?php echo STInput::request('max_people',get_post_meta($post_id ,'max_people', true)) ?>">
