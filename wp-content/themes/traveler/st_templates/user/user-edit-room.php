                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <input id="number_room" name="number_room" placeholder="<?php st_the_language('user_create_room_number_room') ?>" type="text" min="1" value="<?php echo STInput::request('number_room',get_post_meta( $post_id , 'number_room' , true)); ?>"  class="form-control number" >
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <input id="price" name="price" type="text" placeholder="<?php st_the_language('user_create_room_price_per_night') ?>" class="form-control number" value="<?php echo STInput::request('price',get_post_meta($post_id , 'price' , true )) ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <i class="fa fa-cogs input-icon input-icon-hightlight"></i>
                            <input id="discount_rate" name="discount_rate" type="text" placeholder="<?php _e("Discount Rate (%)",ST_TEXTDOMAIN) ?>" class="form-control number" value="<?php echo STInput::request('discount_rate',get_post_meta($post_id , 'discount_rate' , true )) ?>">
                    ...
                    <div class="data_is_sale_schedule">
                        <div class="col-md-6 input-daterange">
                            <div class="form-group form-group-icon-left" >
                                ...
                                <input name="sale_price_from" id="sale_price_from" class="date-pick form-control st_date_start" data-date-format="yyyy-mm-dd" type="text" value="<?php echo STInput::request('sale_price_from',get_post_meta($post_id , 'sale_price_from' , true )) ?>"/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left" >
                                ...
                                <i class="fa fa-calendar input-icon input-icon-hightlight"></i>
                                <input name="sale_price_to" id="sale_price_to" class="date-pick form-control st_date_end" data-date-format="yyyy-mm-dd" type="text" value="<?php echo STInput::request('sale_price_to',get_post_meta($post_id , 'sale_price_to' , true )) ?>" />
