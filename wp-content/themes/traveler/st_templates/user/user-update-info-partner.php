...
<form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner" class="register_form update_info_partner">
    ...
    <div class="tabbable tabs_partner">
        <ul class="nav nav-tabs" id="">
            ...
            <li><a href="#tab-certificates" data-toggle="tab"><?php _e("Certificates Options",ST_TEXTDOMAIN) ?></a></li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade " id="tab-certificates">
                <div class="row">
                    <div class="col-md-12">
                        <?php $data_st_certificates = get_user_meta($user_id,'st_certificates',true); ?>
                        ...
                        <div class="form-group form-group-icon-left">
                            ...
                            if(!empty($url_avatar)){
                                echo '<div class="user-profile-avatar user_seting st_edit">
                                        <div><img style="height:auto" width="300" height="300" class="avatar avatar-300 photo img-thumbnail" src="'.$url_avatar.'" alt=""></div>
