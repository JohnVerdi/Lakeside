        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="tab-location-setting">
                <div class="row">
                    <!-- <div class="col-md-4">
                        <div class="form-group form-group-icon-left">
                            <label for="location_type"><?php echo __('Location Type', ST_TEXTDOMAIN); ?></label>
                            <?php 
                                $check = STInput::request('location_type', 'multi_location');
                            ?>
                            <select name="location_type" id="location_type" class="form-control">
                                <option <?php selected($check, 'multi_location'); ?> value="multi_location"><?php echo __('Multi Location', ST_TEXTDOMAIN); ?></option>
                                <option <?php selected($check, 'check_in_out'); ?> value="check_in_out"><?php echo __('Pickup - Dropoff', ST_TEXTDOMAIN); ?></option>
                            </select>
                        </div>
                    </div> -->
                    ...
                    <!-- <div class="col-md-12 location_from_to_wrapper">
                        <div class="row location-car-wrapper">
                            <div class="overlay">
                                <span class="spinner is-active"></span>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group">
                                    <label for=""><?php echo __('Select a pick up location', ST_TEXTDOMAIN); ?></label>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group">
                                    <label for=""><?php echo __('Select a drop off location', ST_TEXTDOMAIN); ?></label>
                            ...
                            <div class="col-xs-12" style="margin-top: 15px;">
                                <a href="#" class="btn btn-primary" id="add-location-from-to"><?php echo __('Add', ST_TEXTDOMAIN); ?></a>
