...
<li class="<?php echo esc_attr( $class ); ?>">
	...
	<div class="traveler-cart-mini">
		...
		<div class="traveler-cart-footer">
			<a href="<?php echo esc_url( $cart_url ); ?>" class="text-center"><?php echo __('Checkout', ST_TEXTDOMAIN ); ?></a>
		</div>
	</div>
	<?php endif; ?>
</li>
...
<li class="<?php echo esc_attr( $class ); ?>">
	...
	<div class="traveler-cart-mini">
		...
		?>
			<a href="<?php echo esc_url( $check_out_url ); ?>" class="text-center <?php echo $class; ?>" <?php echo $attr; ?>><?php echo __('Checkout', ST_TEXTDOMAIN ); ?></a>
		</div>
	</div>
	<?php endif; ?>
</li>
