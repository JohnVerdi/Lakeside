                        ...
                        <div class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <div class="form-row">
                                    ...
                                    <?php endif; ?>
                                    <?php 
                                        if($section == 'add_booking'): $room_id = isset($POST['room_id']) ? intval($_POST['room_id']) : '';
                                            $room_id = isset($_REQUEST['room_id']) ? intval($_REQUEST['room_id']) : '';
                                            $room_name = (get_post_type($room_id) == 'hotel_room') ? get_the_title($room_id) : '';
                                    ?>
                                            <input id="room_id" type="hidden" name="room_id" value="<?php echo $room_id; ?>" data-post-type="hotel_room" class="form-control form-control-admin st_post_select_ajax " data-pl-name="<?php echo $room_name; ?>">
                                            <input id="item_id" type="hidden" name="item_id" value="<?php echo $room_id; ?>">
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    ?>
                                        <input readonly class="form-control form-control-admin" type="text" name="item_price" id="item_price" value="<?php echo TravelHelper::format_money_from_db($item_price, $currency); ?>">
                                    <?php else:
                                        $item_price = isset($_REQUEST['item_price']) ? $_REQUEST['item_price'] : TravelHelper::format_money_raw(0);
                                    ?>
