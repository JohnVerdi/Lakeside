                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td width="80%">
                                                        ...
                                                        <input id="<?php echo $val['extra_name']; ?>" type="checkbox" class="i-check" name="extra_price[name][]" value="<?php echo $val['extra_name']; ?>" <?php if(in_array($val['extra_name'], $data_item)) echo 'checked="checked"'; ?>><?php echo $val['title'].'('.TravelHelper::format_money_from_db($val['extra_price'], $currency).')'; ?></label>
