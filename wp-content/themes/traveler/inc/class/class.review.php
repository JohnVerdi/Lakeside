...
if(!class_exists('STReview'))
{
    class STReview
    {
        ...
        function init()
        {
            ...
            if(!is_admin()){
                add_filter( 'comments_clauses', array($this,'st_comments_clauses'), 10, 2 );
                add_filter( 'wp_count_comments', array( $this, 'st_wp_count_comments' ), 10, 3 );
            }

            add_filter( 'notify_moderator', array( $this, '_check_notify_moderator' ) );
            add_filter( 'notify_post_author', array( $this, '_check_notify_post_author' ) );

            add_action( 'pre_comment_on_post', array( $this, '_check_pre_comment_on_post') );
        ...
        */
        ...
        function save_comment_meta_data( $comment_id ) {
            ...
            global $wpdb;
            $array =  array('comment_type'=>'st_reviews','comment_approved' => 1 );
            ...
            $wpdb->update( $wpdb->comments, $array, array('comment_ID'=>$comment_id) ) ;
        ...
        */
        ...
        function st_comments_clauses($sql){  
            ...
            $sql['where'] .=" ".$st_comments_clauses.".post_type NOT IN ({$disable_list}) ";
        ...
        function st_wp_count_comments($stats,$post_id){
            ...
            if ( 0 === $post_id ) {
                ...
                if (!$stats) $stats = (object)array('approved'=>1,'trash'=>1,'spam'=>1,'moderated'=>1,'total_comments'=>1,'all'=>1);
