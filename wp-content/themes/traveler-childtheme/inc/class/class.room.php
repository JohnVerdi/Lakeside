...
if(!class_exists('STRoom'))
{
    class STRoom extends TravelerObject
    {
        ...
        function init()
        {
            ...
            add_action('st_wc_cart_item_information_hotel_room', array($this, '_show_wc_cart_item_information'));

            add_action('st_before_cart_item_hotel_room', array($this, '_show_wc_cart_post_type_icon'));
        ...
        {
            echo st()->load_template('hotel-room/wc_cart_item_information', FALSE, array('st_booking_data' => $st_booking_data));
        }
        /**
         *
         *
        ...
        function _get_where_query($where)
        {
            ...
            if( isset( $st_search_args['location_id'] ) && !empty( $st_search_args['location_id']) ){
                ...
                $where = TravelHelper::_st_get_where_location( $location_id, array('hotel_room'), $where );
                ...
                if( !empty( $ids_location) && is_array( $ids_location ) ){
                    $where .= TravelHelper::_st_get_where_location( $ids_location, array('hotel_room') , $where);
                }else{
        ...
        {
            return st()->load_template('hotel-room/cart_item_html', NULL, array('item_id' => $item_id));
        }
        ...
        static function get_search_fields_name()
        {
            return array(
                         ...
                         'sttype'      => array(
                             'value' => 'sttype',
                             'label' => __('Streamline Rental Type', ST_TEXTDOMAIN)
                         ),
                        'stlocation'      => array(
                            'value' => 'stlocation',
                            'label' => __('Streamline Location', ST_TEXTDOMAIN)
                        ),
                         'checkin'       => array(
                             'value' => 'checkin',
