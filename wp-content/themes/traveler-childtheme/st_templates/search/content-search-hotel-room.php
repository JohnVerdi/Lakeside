    ...
    <form role="search" method="get" class="search main-search" action="<?php echo esc_url($link_action) ?>">
        ...
        <div class="row">
            ...
            <div class=" col-md-3 col-lg-3 col-sm-12 col-xs-12 ">
	            <div class="form-group form-group-lg form-group-select-plus main-search-button">
					<button class="main-search btn btn-primary btn-lg" type="submit"><?php _e("Search for Room",ST_TEXTDOMAIN)?></button>
	            </div>
            </div>
        </div>
        <?php
