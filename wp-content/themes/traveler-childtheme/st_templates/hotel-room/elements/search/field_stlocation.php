...
<!--            <option value="">— Select —</option>-->
            <?php foreach (StreamlineCore_Wrapper::get_location_resorts() as $k => $location):?>
                ...
                <label>
                    <input class="i-check item_tanoxomy" name="resort_area_id[]" type="checkbox" value="<?php echo $location->id ;?>" style="position: absolute; opacity: 0;"><?php echo $location->name ;?>
                </label>
                </div>
